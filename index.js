...
</head><body style="background:#f8f8f8;color:#333;font-family:sans-serif;text-align:center;padding:40px">
<p>جارٍ التحميل...</p><a href="/" style="color:#333">العودة للمتجر</a>
...
${[
  ...
  ["GET","/api-docs","هذه الصفحة","admin"],
    ...
    return RR(buildHTML(settings),200,{"Cache-Control":"public,max-age=60","X-Content-Type-Options":"nosniff","X-Frame-Options":"DENY","Content-Security-Policy":"default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: *; connect-src 'self'; frame-ancestors 'none'"});
   }catch(err){
    try{
...
function buildHTML(s){
  const sn=s.storeName||"STORE_NAME";
  const wa=s.whatsapp||"";
  const em=s.email||"";
...
<header class="hdr">
  <div class="hdr-i">
    <a href="#" class="logo" id="store-name-hdr" aria-label="متجر">
    ...
    <div class="search-wrap">
      ...
      <input class="search-inp" id="search-inp" type="text" placeholder="ابحث عن منتج..." oninput="STORE.liveSearch(this.value)">
    </div>
    <div class="hdr-r">
      ...
      <div class="lang-sw" id="lang-sw">
        <button class="lang-btn" id="lang-btn-hdr" title="اللغة / Language">AR</button>
        <div class="lang-menu" id="lang-menu">
          <div class="lang-opt on" data-lang="ar">العربية</div>
...
<footer class="footer">
  ...
  <div class="footer-copy">${sn} — جميع الحقوق محفوظة</div>
</footer>
